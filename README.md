...
<!-- <h4 align="center"> 
---
	🚧  Projeto buscador de música através de api 🚀 Em construção...  🚧
</h4> 

<hr> -->

<div align="center" id="top">
  <img alt="music search" title="music search" src="./gif-letter.gif"/>
</h1>
...
```sh
• Aplicação web que utiliza uma api contendo letras de música e devolve a música pesquisada conforme entrada do usuário.
```

## :sparkles: Funcionalidades ##


:heavy_check_mark: Devolve letra da música pesquisada através da entrada do nome da banda e da música;\
:heavy_check_mark: Utiliza a requisição do tipo get para uma api retornando um arquivo json com a música escolhida;\
...
# Clone este repositorio
 -> git bash here
  $ https://github.com/LucasFeliciano02/api-web-busca-musica.git
